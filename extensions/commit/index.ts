...
function buildCommitPrompt(options: CommitPromptOptions): string {
	return [
		...
		"2. Follow skills/pac-commit/SKILL.md for branch safety, gitmoji shortlist selection, atomic grouping, OpenSpec slice rules, and explicit staging.",
		"3. Restrict your analysis and commit staging to the scoped files listed below.",
		"4. Group the scoped changes into logical, atomic units. Unrelated changes belong in separate commits.",
		"5. If there is more than one unrelated commit group, STOP and present the proposed split for approval before committing anything.",
		"6. For each approved commit group:",
		...
		"7. Report each resulting commit hash and message.",
		"",
		"Constraints:",
		"- Never use --no-verify.",
