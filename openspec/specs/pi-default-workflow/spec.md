# pi-default-workflow Specification

## Purpose

Define Pi as the repository's sole supported day-to-day interface, with the README as the primary active setup document and package metadata aligned with the Pi-only repository layout.
