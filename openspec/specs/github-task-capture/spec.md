# github-task-capture Specification

## Purpose

Capture future work as GitHub issues from the current repository through a lightweight or guided issue-creation workflow.
